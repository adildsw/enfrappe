...
const getComponentCompatibility = (parentComponent) => {
    if (parentComponent === UIItemTypes.ACTIVITY)
        ...
        return [UIItemTypes.BUTTON, UIItemTypes.CHART, UIItemTypes.CHECKBOX, UIItemTypes.DROPDOWN, UIItemTypes.DATAVIEWER, UIItemTypes.INPUT, UIItemTypes.IMAGE, UIItemTypes.RADIO, UIItemTypes.TEXT];
    else
